...
<link href="/css_cliente/detalle.css" rel="stylesheet">
<div class="container">
    <!-- product -->
        ...
        <div class="row">
                    ...
                    <div id="myCarousel-2" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <img src="{{$producto->image}}" class="img-responsive" alt="" />
                            </div>
                            <!-- Slide 2 -->
                            <div class="item">
            ...
            <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                <h2 class="name">
                    ...
                    <span class="fa fa-2x"><h5>{{$producto->rating->count}} Votes</h5></span>
